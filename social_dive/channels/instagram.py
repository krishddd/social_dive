"""
Instagram channel (login-gated, read-only via browser session).

⚠️ ToS / BAN RISK: automated access violates Instagram's terms. Use a throwaway
...
@register_channel
class InstagramChannel(CliRoutingChannel):
    name = "instagram"
    ...
    _URL_PATTERNS = [r"(?:^|//)(?:www\.)?instagram\.com/"]
